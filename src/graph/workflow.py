...
from graph.nodes import generate_queries_node, retrieve_node, generate_answer_node, grade_answer_node
...
def decide_to_finish(state: GraphState):
    ...
    """
    if state.get("evaluation") == "useful":
        return "finish"

    if state.get("loop_step") >= 2:
        return "force_finish"
